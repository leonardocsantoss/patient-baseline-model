...
data$hr = data$bp = data$rr = data$pt = data$gl = data$co2 = NULL
...
# 31 <= pt_value < 43
data = subset(data, pt_value>=31)
data = subset(data, pt_value<43)
...
summary(lm(rr_value ~ other_neurological + paralysis + hypertension + cardiac_arrhythmias + gl_value + chronic_pulmonary + diabetes_complicated + hypothyroidism + rheumatoid_arthritis + last_drug + obesity + pt_value + pulmonary_circulation + renal_failure + metastatic_cancer + sex + coagulopathy + congestive_heart_failure + fluid_electrolyte + sbp_value + liver_disease + solid_tumor + alcohol_abuse + deficiency_anemias + height + weight + valvular_disease + co2_value + admit_age + weight_loss + diabetes_uncomplicated + charttime_time + peripheral_vascular + hr_value + lymphoma + pt_value:gl_value + hr_value:pt_value + admit_age:weight + height:sbp_value + hr_value:gl_value + admit_age:sbp_value + height:weight + hr_value:co2_value + weight:co2_value + sex:gl_value + weight:pt_value + sex:hr_value + sex:pt_value + sex:co2_value + weight:gl_value + sex:weight + admit_age:co2_value + hr_value:sbp_value + admit_age:height + weight:sbp_value + admit_age:gl_value + height:hr_value + sbp_value:pt_value + admit_age:pt_value + admit_age:hr_value + sbp_value:co2_value + sex:sbp_value + height:gl_value + height:pt_value + height:co2_value + sex:admit_age + gl_value:co2_value + weight:hr_value + pt_value:co2_value + sex:height + sbp_value:gl_value, data=data))$r.squared
summary(lm(hr_value ~ hypothyroidism + weight_loss + renal_failure + lymphoma + obesity + metastatic_cancer + chronic_pulmonary + fluid_electrolyte + rheumatoid_arthritis + co2_value + liver_disease + height + alcohol_abuse + admit_age + peripheral_vascular + sex + pulmonary_circulation + gl_value + paralysis + other_neurological + weight + diabetes_uncomplicated + rr_value + last_drug + coagulopathy + valvular_disease + deficiency_anemias + solid_tumor + pt_value + charttime_time + cardiac_arrhythmias + congestive_heart_failure + diabetes_complicated + hypertension + sbp_value + sex:gl_value + sex:rr_value + weight:sbp_value + height:pt_value + sex:weight + height:co2_value + sbp_value:gl_value + admit_age:pt_value + pt_value:co2_value + admit_age:sbp_value + sex:co2_value + height:weight + gl_value:co2_value + rr_value:co2_value + height:sbp_value + weight:gl_value + admit_age:rr_value + admit_age:co2_value + sex:height + pt_value:gl_value + height:rr_value + admit_age:height + sex:pt_value + height:gl_value + rr_value:sbp_value + sbp_value:pt_value + weight:rr_value + sex:sbp_value + rr_value:pt_value + admit_age:weight + rr_value:gl_value + weight:pt_value + weight:co2_value + admit_age:gl_value + sbp_value:co2_value + sex:admit_age, data=data))$r.squared
summary(lm(sbp_value ~ co2_value + pt_value + renal_failure + diabetes_complicated + lymphoma + pulmonary_circulation + alcohol_abuse + congestive_heart_failure + diabetes_uncomplicated + chronic_pulmonary + paralysis + peripheral_vascular + gl_value + other_neurological + hypertension + metastatic_cancer + deficiency_anemias + sex + weight + coagulopathy + solid_tumor + last_drug + charttime_time + hypothyroidism + admit_age + cardiac_arrhythmias + rr_value + rheumatoid_arthritis + valvular_disease + weight_loss + obesity + liver_disease + fluid_electrolyte + height + hr_value + admit_age:gl_value + weight:co2_value + height:weight + weight:pt_value + rr_value:pt_value + sex:gl_value + sex:pt_value + rr_value:hr_value + sex:hr_value + rr_value:gl_value + admit_age:height + hr_value:co2_value + height:rr_value + admit_age:pt_value + hr_value:gl_value + hr_value:pt_value + sex:weight + sex:co2_value + admit_age:rr_value + sex:height + height:pt_value + rr_value:co2_value + gl_value:co2_value + weight:gl_value + weight:hr_value + admit_age:weight + sex:admit_age + height:gl_value + height:hr_value + pt_value:co2_value + height:co2_value + sex:rr_value + admit_age:co2_value + weight:rr_value + admit_age:hr_value + pt_value:gl_value, data=data))$r.squared
summary(lm(pt_value ~ sbp_value + rr_value + solid_tumor + deficiency_anemias + height + paralysis + coagulopathy + obesity + fluid_electrolyte + other_neurological + peripheral_vascular + admit_age + co2_value + alcohol_abuse + congestive_heart_failure + lymphoma + metastatic_cancer + liver_disease + last_drug + gl_value + charttime_time + weight_loss + hypertension + diabetes_complicated + cardiac_arrhythmias + valvular_disease + hypothyroidism + renal_failure + chronic_pulmonary + weight + diabetes_uncomplicated + sex + hr_value + rheumatoid_arthritis + pulmonary_circulation + rr_value:sbp_value + hr_value:co2_value + hr_value:sbp_value + rr_value:gl_value + hr_value:gl_value + height:weight + rr_value:hr_value + weight:sbp_value + sex:admit_age + sex:co2_value + height:hr_value + sex:hr_value + admit_age:hr_value + height:co2_value + weight:gl_value + sbp_value:co2_value + sbp_value:gl_value + sex:weight + height:rr_value + sex:gl_value + rr_value:co2_value + admit_age:height + weight:rr_value + sex:rr_value + admit_age:weight + admit_age:sbp_value + sex:height + gl_value:co2_value + height:gl_value + admit_age:gl_value + weight:hr_value + admit_age:co2_value + height:sbp_value + weight:co2_value + sex:sbp_value + admit_age:rr_value, data=data))$r.squared
